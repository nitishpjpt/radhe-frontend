    ...
    <footer className="w-full">
      ...
      <div className="bg-gray-900 text-white py-10 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 text-center md:text-left">
          ...
          <div className="flex flex-col items-center">
            <img
              ...
              src={Logo}
              alt="Radhe Laptops Logo"
            />
            <h5 className="text-sm font-semibold uppercase mt-4">
              Follow us on
            </h5>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link to="/brands/asus" className="hover:text-white">
                  Asus
                </Link>
              </li>
              <li>
                <Link to="/brands/lenovo" className="hover:text-white">
                  Lenovo
                </Link>
              </li>
              <li>
                <Link to="/brands/mi" className="hover:text-white">
                  Mi
                </Link>
              </li>
              <li>
                <Link to="/brands/apple" className="hover:text-white">
                  Apple
                </Link>
              </li>
              <li>
                <Link to="/brands/dell" className="hover:text-white">
                  Dell
                </Link>
              </li>
              <li>
                <Link to="/brands/hp" className="hover:text-white">
                  HP
                </Link>
              </li>
              <li>
                <Link to="/brands/acer" className="hover:text-white">
                  Acer
                </Link>
              </li>
              <li>
                <Link to="/brands/toshiba" className="hover:text-white">
                  Toshiba
                </Link>
              </li>
            </ul>
        ...
        <div className="text-center mt-8 text-gray-400">
          <p>
            Copyright © 2025{" "}
            <span className="font-semibold">Radhe Laptops</span>. All rights
            reserved.
          </p>
        </div>
      </div>
